...
${OBJECTDIR}/categoryGraph.o: categoryGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/categoryGraph.o categoryGraph.cpp
...
${OBJECTDIR}/similarityMatrix.o: similarityMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/similarityMatrix.o similarityMatrix.cpp
...
${OBJECTDIR}/userGraph.o: userGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/userGraph.o userGraph.cpp
